...
public class DBQuery {
    ...
    public static ObservableList<Flight> searchFlights
        ...
        try {
            ...
            if (arr == null) {
                master = master.replace(("arrive " + target), ("arrive " + notClause));
            }

            if (depT == null) {
                master = master.replace(("depTime " + target), ("depTime " + notClause));
            }

            if (depD == null) {
                master = master.replace(("depDate " + target), ("depDate " + notClause));
            }
